...
export const GAMES: Project[] = [
  ...
  },
  {
    type: 'gaming',
    name: 'VyreCasino',
    blurb: 'On-chain Blackjack powered by Rise VRF and Shreds for real-time gameplay. Bet USDC with gasless session keys via Rise Wallet. Provably fair 3:2 blackjack payouts!',
    logo: '/projects/vyrecasino/logo.png',
    banner: '/projects/vyrecasino/banner.png',
    status: 'live',
    x: 'https://x.com/VyreCasino',
    website: 'https://www.vyre.top/',
    docs: 'https://docs.vyre.top/',
    tags: ['Gaming', 'Casino', 'AA'],
    native: true,
  }
];
